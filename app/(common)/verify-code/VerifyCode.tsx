...
export default function VerifyCode({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    onSubmit(value) // Pass the OTP to the parent component
  }
  ...
  const mfaUser = async () => {
    ...
    if (isBrowser()) {
      mfaValidationToken = window?.sessionStorage?.getItem(
        "mfaValidateToken"
      ) as string
    }
      ...
      >
        <Border className={cn("flex flex-col p-8 w-full lg:w-2/5")}>
          <>
            ...
            <div className="text-center text-sm">
              ...
              {value.length === 6 ? (
                ...
                <>
                  ...
                  number ending in *****@gmail.com / ******1122.
                </>
              )}
            </div>
            <br />
            ...
            <CustomLink href={`/verify-user`} className="text-blue-500 my-2">
              Send New Code
            </CustomLink>
          </>
        </Border>
